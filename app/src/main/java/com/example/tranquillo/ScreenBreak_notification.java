...
public class ScreenBreak_notification extends AppCompatActivity {
    ...
    ScreenBreakNotifData notificationData;
    private java.util.Locale Locale;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_screen_break_notification);
        initLayout();

        String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        dbRef = FirebaseDatabase.getInstance().getReference().child("Screen Break").child(uid);
        ...
        dbRef.get().addOnSuccessListener(new OnSuccessListener<DataSnapshot>() {
            ...
            public void onSuccess(DataSnapshot dataSnapshot) {
                notificationData = new ScreenBreakNotifData(ScreenBreak_notification.this, dataSnapshot);
                updateUI();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(ScreenBreak_notification.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
   ...
   private void updateTimeInUI(TextView textView, int startTime, int endTime) {
    ...
    private void setupMainButton() {
        mainButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(ScreenBreak_notification.this)
   ...
   private void showStartTimeDialog(int option) {
        ...
        TimePickerDialog startTimeDialog = new TimePickerDialog(ScreenBreak_notification.this,
                startTimeListener,
                0,
                0,
    ...
    private void showEndTimeDialog(int option, int startTime) {
        ...
        TimePickerDialog endTimeDialog = new TimePickerDialog(ScreenBreak_notification.this,
                endTimeListener,
                0,
                0,
                DateFormat.is24HourFormat(getBaseContext()));
   ...
   private void setTime(int option, int startTime, int endTime) {
   ...
   private void deleteTime(int option) {
        boolean setAll = false;
        switch (option) {
            case 0: {
                setAll = true;
   ...
   private void pushNewData() {
        dbRef.setValue(notificationData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        notificationData.updateLocalData(ScreenBreak_notification.this);
                        Toast toast = Toast.makeText(ScreenBreak_notification.this, "Success", Toast.LENGTH_SHORT);
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast toast = Toast.makeText(ScreenBreak_notification.this, e.getMessage(), Toast.LENGTH_SHORT);
                View view = toast.getView();
                TextView text = view.findViewById(android.R.id.message);
                view.setBackground(getDrawable(R.drawable.rounded_toast));
                text.setTextColor(Color.parseColor("#522749"));
                ...
                toast.show();
                e.printStackTrace();
                startActivity(new Intent(ScreenBreak_notification.this, ScreenBreak_notification.class));
                finish();
            }
        });
    }
    ...
    {
        Intent btn_back = new Intent(ScreenBreak_notification.this,Notifications.class);
