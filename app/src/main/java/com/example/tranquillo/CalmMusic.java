...
public class CalmMusic extends AppCompatActivity {
    //Initialise variable
    ...
    public void onclick_instrumental(View view)
    {
        Intent instrumental_btn = new Intent(CalmMusic.this,Instrumental.class);
        startActivity(instrumental_btn);
        finish();
    }

    public void btn_back(View view)
    {
        Intent back_btn = new Intent(CalmMusic.this,navigation_drawer.class);
