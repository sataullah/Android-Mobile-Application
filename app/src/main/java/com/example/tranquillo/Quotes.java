...
public class Quotes extends AppCompatActivity {
    ...
    {
        Intent perseverance_btn = new Intent(Quotes.this,Perseverance_first.class);
        startActivity(perseverance_btn);
        finish();
    }
    ...
    {
        Intent back_btn = new Intent(Quotes.this,navigation_drawer.class);
